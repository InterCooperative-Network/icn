...
- `python3 docs/scripts/doc_control_check.py --repo . --registry docs/registry.toml --strict` — `OK: doc control check passed (777 docs markdown files under docs/); 36 enforcement warnings` (baseline; no new warnings)

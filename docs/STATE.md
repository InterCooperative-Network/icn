...
<!-- [sync edit] 2026-06-26 (A2d target verification — #2199 MERGED, squash `08acb0e5` = `origin/main` tip, parent `4d5e027f` (#2198); docs-only, branch `docs/sync-a2d-target-verification`):

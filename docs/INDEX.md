...
- [replay-state-restart-invariants.md](architecture/replay-state-restart-invariants.md) - Replay durability invariants across restart: why the acceptance floor must equal the durable high-water exactly, the restart timestamp barrier, and freshness as the basis for replay-state expiry

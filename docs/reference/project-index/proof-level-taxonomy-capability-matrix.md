...
| 7 | Fixture-backed organizer rehearsal shell | **L2** | fixture-backed | [#1999](https://github.com/InterCooperative-Network/icn/pull/1999), [#2237](https://github.com/InterCooperative-Network/icn/pull/2237); `web/pilot-ui/fixtures/icn-organizer-demo/` | fixtures must be fictional; no private paths / Drive URLs; review choices are disabled | human/AT pass + live path ([#1746](https://github.com/InterCooperative-Network/icn/issues/1746)) |
...
**7. Fixture-backed organizer rehearsal shell — L2.** *Real now:* a demo-mode shell renders committed fictional fixtures (`rehearsal-shell.manifest.json`), validated by `docs/scripts/validate-rehearsal-shell-fixtures.py`. In addition to Standing and Action Cards, [#2237](https://github.com/InterCooperative-Network/icn/pull/2237) renders the `preview-review` wrapper and canonical-matched pending-publish rows as a plain-language, read-only **Review Preview**; every review choice is disabled, the browser fixture is schema-valid and mechanically matched to the canonical example, and Playwright/axe covers the rendered surface. *Fixture-only / mocked:* **entirely** — there is no live daemon, persisted review decision, mutation, issued receipt, or evidence export behind the shell in demo mode. *Public/demo wording:* "fixture-backed organizer review preview and participation shell (demo mode) — bounded fictional rehearsal artifacts; no decisions recorded, not live, not a formal pilot." *Known gaps:* not wired to a live preview/review endpoint; no human/assistive-technology pass; not a partner rehearsal (L7); the full participation surface and organizer walkthrough remain under [#1746](https://github.com/InterCooperative-Network/icn/issues/1746).

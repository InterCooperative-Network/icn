...
8. **If the policy version is superseded but not deprecated:** selection prefers the successor unless the domain has explicitly held the predecessor. Holding a predecessor past supersession is a governance act with its own receipt.

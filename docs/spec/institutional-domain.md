...
Error mapping: undeclared `InstitutionalDomain` → 404; missing store / backend read-write failure → 500; gate or pure-core structural authority refusal → 403; empty/whitespace or oversize `policy_content`, or a malformed body/DID → 400.

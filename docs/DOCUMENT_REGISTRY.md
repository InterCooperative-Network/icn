...
- **Files scanned:** 813 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 290 (remaining files rely on `[[doc_path_defaults]]` only)

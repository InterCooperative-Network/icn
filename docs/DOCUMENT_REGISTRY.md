...
- **Files scanned:** 807 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 288 (remaining files rely on `[[doc_path_defaults]]` only)

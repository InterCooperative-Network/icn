...
- **Files scanned:** 885 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 305 (remaining files rely on `[[doc_path_defaults]]` only)

...
- **Files scanned:** 911 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 326 (remaining files rely on `[[doc_path_defaults]]` only)

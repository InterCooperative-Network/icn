...
- **Files scanned:** 951 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 349 (remaining files rely on `[[doc_path_defaults]]` only)

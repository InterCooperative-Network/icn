...
- **Files scanned:** 927 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 341 (remaining files rely on `[[doc_path_defaults]]` only)

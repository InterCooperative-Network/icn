...
- **Files scanned:** 815 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 291 (remaining files rely on `[[doc_path_defaults]]` only)

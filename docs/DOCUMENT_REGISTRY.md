...
- **Files scanned:** 776 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 283 (remaining files rely on `[[doc_path_defaults]]` only)

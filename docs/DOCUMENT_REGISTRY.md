...
- **Files scanned:** 805 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 287 (remaining files rely on `[[doc_path_defaults]]` only)

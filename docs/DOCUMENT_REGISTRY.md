...
- **Files scanned:** 922 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 336 (remaining files rely on `[[doc_path_defaults]]` only)

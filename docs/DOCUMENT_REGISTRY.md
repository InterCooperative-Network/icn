...
- **Files scanned:** 910 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 325 (remaining files rely on `[[doc_path_defaults]]` only)

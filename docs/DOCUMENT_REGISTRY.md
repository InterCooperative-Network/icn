...
- **Files scanned:** 972 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 371 (remaining files rely on `[[doc_path_defaults]]` only)

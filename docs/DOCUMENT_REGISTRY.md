...
- **Files scanned:** 909 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 324 (remaining files rely on `[[doc_path_defaults]]` only)

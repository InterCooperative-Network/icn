...
- **Files scanned:** 818 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 292 (remaining files rely on `[[doc_path_defaults]]` only)

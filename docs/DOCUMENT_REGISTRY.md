...
- **Files scanned:** 944 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 348 (remaining files rely on `[[doc_path_defaults]]` only)

...
- **Files scanned:** 973 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 372 (remaining files rely on `[[doc_path_defaults]]` only)

...
- **Files scanned:** 803 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 286 (remaining files rely on `[[doc_path_defaults]]` only)

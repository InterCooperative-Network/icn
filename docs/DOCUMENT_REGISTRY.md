...
- **Files scanned:** 921 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 335 (remaining files rely on `[[doc_path_defaults]]` only)

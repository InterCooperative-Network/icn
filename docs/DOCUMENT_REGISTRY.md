...
- **Files scanned:** 904 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 320 (remaining files rely on `[[doc_path_defaults]]` only)

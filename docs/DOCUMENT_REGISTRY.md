...
- **Files scanned:** 802 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 285 (remaining files rely on `[[doc_path_defaults]]` only)

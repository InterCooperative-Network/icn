...
- **Files scanned:** 920 Markdown files under `docs/`
- **Explicit `[docs."…"]` rows under `docs/`:** 334 (remaining files rely on `[[doc_path_defaults]]` only)

> **ARCHIVED 2026-07-13.** This is the 2025-era "Institution-in-a-Box" vision, preserved unchanged below the marker.
> It described a municipal-OS product bundle, a "mana"-metered compute economy, and a philosophy-first adoption wedge —
> all retired. The current vision lives at the repository root: [`VISION.md`](../../../VISION.md).
> Retirement context: 2026-07-13 ecosystem audit; current doctrine: `docs/genesis.md`, `docs/architecture/KERNEL_APP_SEPARATION.md`.

...
STATUS_BY_COMMAND: dict[str, tuple[str, str]] = {
    ...
    "steward info": (STATUS_PARTIAL, "gateway client `reqwest GET {gateway}/v1/steward/by-did/{did}` (route in route-inventory) (`icn/bins/icnctl/src/main.rs` StewardCommands::Info); requires a running gateway, not integration-tested"),

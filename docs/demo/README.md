...
| Doc | Use it for |
|-----|-----------|
| [JULY_DEMO_CANDIDATE_0.1_RELEASE_PACKET.md](JULY_DEMO_CANDIDATE_0.1_RELEASE_PACKET.md) | **Read first — hand-off packet** — what it is/proves/doesn't, who it's for, how to run, how to review evidence, safe-to-share vs never-share, known gaps, next lanes. |

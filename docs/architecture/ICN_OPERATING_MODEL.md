...
| **Manifest** | Declared shape of a tool/service/workload: capabilities, data touched, storage, privacy, receipts emitted. | [`../spec/governed-service-binding.md`](../spec/governed-service-binding.md), RFC-0017 |

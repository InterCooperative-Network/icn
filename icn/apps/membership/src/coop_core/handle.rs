...
impl CoopHandle {
    ...
    pub async fn create_cooperative(
        ...
        self.tx
            ...
            .await
            .map_err(|_| super::error::CoopError::Governance("Actor disconnected".into()))?;
        rx.await
            .map_err(|_| super::error::CoopError::Governance("Reply failed".into()))?
    }

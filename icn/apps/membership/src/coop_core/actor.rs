...
use super::store::CoopStore;
use super::types::{
    AssetDistributionPlan, CoopType, Cooperative, FormationRequest, Member, MemberRole,
};
...
impl CoopActor {
    ...
    async fn handle_create_treasury(&mut self, coop_id: &str) -> Result<String> {
        ...
        if coop.treasury_did.is_some() {
            return Err(super::error::CoopError::Governance(format!(
...
mod tests {
    use super::*;
    use crate::coop_core::handle::CoopHandle;
    use crate::coop_core::types::{
        AssetDistributionPlan, BalanceAction, CapitalReturnMethod, CoopStatus, CoopType,
        DebtAction, FormationRequest, MemberRole, MemberStatus,
    };

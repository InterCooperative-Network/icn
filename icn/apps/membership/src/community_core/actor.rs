...
use super::lifecycle::CommunityLifecycle;
use super::membership::MembershipManager;
use super::resources::ResourceManager;
use super::store::CommunityStore;
use super::types::{Community, CommunityType, MemberType};
...
pub enum CommunityMessage {
    ...
    ListMembers {
        community_id: String,
        reply: oneshot::Sender<Result<Vec<super::types::Member>>>,
    },
    AllocateResource {
        community_id: String,
        pool_name: String,
    ...
    GetResourcePools {
        community_id: String,
        reply: oneshot::Sender<Result<Vec<super::types::ResourcePool>>>,
    },
    Update {
        community_id: String,
        name: Option<String>,
...
impl CommunityActor {
    ...
    async fn handle_create(
        ...
        let request = super::lifecycle::FormationRequest {
            name: name.clone(),
            community_type,
    ...
    fn handle_list_members(&self, community_id: &str) -> Result<Vec<super::types::Member>> {
    ...
    fn handle_get_resource_pools(
        &self,
        community_id: &str,
    ) -> Result<Vec<super::types::ResourcePool>> {
        let community = self.handle_get(community_id)?;

...
impl NetworkHandle {
    ...
    pub async fn sample_peers(&self, scope: crate::gossip::Scope, count: usize) -> Vec<Did> {
    ...
    pub async fn get_peers_with_blob(
        &self,
        blob_hash: &crate::gossip::types::ContentHash,
    ...
    pub async fn find_peers_with_all(
        &self,
        blob_hashes: &[crate::gossip::types::ContentHash],
    ...
    pub async fn announce_blob_availability(
        ...
        let gossip_msg = crate::gossip::types::GossipMessage::BlobAnnounce {
            blob_hash,
            peer_did,
            size_bytes,
        };

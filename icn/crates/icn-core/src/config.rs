...
pub struct NeighborLimitsConfig {
    /// Maximum local cluster neighbors
    #[serde(default = "default_max_local")]
    pub max_local_cluster: usize,

    /// Maximum regional neighbors
    #[serde(default = "default_max_regional")]
    pub max_regional: usize,

    /// Maximum backbone neighbors
    #[serde(default = "default_max_backbone")]
    pub max_backbone: usize,

    /// Maximum trusted neighbors (cross-region high-trust)
...
pub struct FanoutConfig {
    ...
    #[serde(default = "default_fanout_local")]
    pub local_cluster: usize,

    /// Fanout for regional scope
    #[serde(default = "default_fanout_regional")]
    pub regional: usize,

    /// Fanout for global scope
    #[serde(default = "default_fanout_global")]
    pub global: usize,
}
...
fn default_max_regional() -> usize {
    30
}

fn default_max_backbone() -> usize {
    20
}
...
fn default_fanout_local() -> usize {
    8
}

fn default_fanout_regional() -> usize {
    6
}

fn default_fanout_global() -> usize {
    4
}

impl Default for NeighborLimitsConfig {
    fn default() -> Self {
        NeighborLimitsConfig {
            max_local_cluster: default_max_local(),
            max_regional: default_max_regional(),
            max_backbone: default_max_backbone(),
            max_trusted: default_max_trusted(),
        }
    }
}
...
impl Default for FanoutConfig {
    fn default() -> Self {
        FanoutConfig {
            local_cluster: default_fanout_local(),
            regional: default_fanout_regional(),
            global: default_fanout_global(),
        }
    }
}

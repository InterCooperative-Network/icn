...
fn test_multi_graph_complete_trust_network() {
    ...
    multi
        .social_mut()
        .add_edge(TrustEdge::new(alice.did().clone(), bob.did().clone(), TrustScore::unchecked(0.8)))
        .unwrap();
    multi
        .social_mut()
        .add_edge(TrustEdge::new(bob.did().clone(), carol.did().clone(), TrustScore::unchecked(0.7)))
        .unwrap();

    // Economic reliability: Alice has done business with Bob, Bob with Dave
    multi
        .economic_mut()
        .add_edge(TrustEdge::new(alice.did().clone(), bob.did().clone(), TrustScore::unchecked(0.9)))
        .unwrap();
    multi
        .economic_mut()
        .add_edge(TrustEdge::new(bob.did().clone(), dave.did().clone(), TrustScore::unchecked(0.6)))
        .unwrap();
    ...
    multi
        .technical_mut()
        .add_edge(TrustEdge::new(carol.did().clone(), dave.did().clone(), TrustScore::unchecked(0.8)))
        .unwrap();
...
fn test_multi_graph_dimension_specific_operations() {
    ...
    multi
        .add_edge_to(
            ...
            TrustEdge::new(alice.did().clone(), bob.did().clone(), TrustScore::unchecked(0.9)),
        )
        .unwrap();
    ...
    multi
        .add_edge_to(
            ...
            TrustEdge::new(alice.did().clone(), bob.did().clone(), TrustScore::unchecked(0.3)),
        )
        .unwrap();
    ...
    multi
        .add_edge_to(
            ...
            TrustEdge::new(alice.did().clone(), bob.did().clone(), TrustScore::unchecked(0.5)),
        )
        .unwrap();
...
fn test_complex_transitive_trust_network() {
    ...
    graph
        ...
        .unwrap();
    graph
        .add_edge(TrustEdge::new(bob.did().clone(), dave.did().clone(), TrustScore::unchecked(0.7)))
        .unwrap();
    graph
        .add_edge(TrustEdge::new(carol.did().clone(), dave.did().clone(), TrustScore::unchecked(0.9)))
        .unwrap();
    graph
        .add_edge(TrustEdge::new(bob.did().clone(), eve.did().clone(), TrustScore::unchecked(0.5)))
        .unwrap();
...
fn test_custom_scoring_weights() {
    ...
    graph
        .add_edge(TrustEdge::new(alice.did().clone(), bob.did().clone(), TrustScore::unchecked(1.0)))
        .unwrap();
    graph
        .add_edge(TrustEdge::new(bob.did().clone(), carol.did().clone(), TrustScore::unchecked(1.0)))
        .unwrap();
...
fn test_trust_class_from_graph() {
    ...
    graph
        .add_edge(TrustEdge::new(alice.did().clone(), bob.did().clone(), TrustScore::unchecked(0.95)))
        .unwrap(); // → Federated
    graph
        .add_edge(TrustEdge::new(
            alice.did().clone(),
        ...
        .unwrap(); // → Known
    graph
        .add_edge(TrustEdge::new(alice.did().clone(), dave.did().clone(), TrustScore::unchecked(0.1)))
        .unwrap(); // → Isolated
...
fn test_edge_expiry_filtering() {
    ...
    // Add expired edge
    let expired_edge =
        TrustEdge::new(alice.did().clone(), bob.did().clone(), TrustScore::unchecked(0.8)).with_expiry(now - 100); // Expired 100 seconds ago
...
fn test_outgoing_edges_expiry_filtering() {
    ...
    graph
        .add_edge(
            TrustEdge::new(alice.did().clone(), bob.did().clone(), TrustScore::unchecked(0.8)).with_expiry(now + 3600), // Valid for 1 hour
        )
        .unwrap();

    graph
        .add_edge(
            TrustEdge::new(alice.did().clone(), carol.did().clone(), TrustScore::unchecked(0.7)).with_expiry(now - 100), // Already expired
        )
        .unwrap();
...
fn test_get_all_known_dids_multi_graph() {
    ...
    multi
        .social_mut()
        .add_edge(TrustEdge::new(alice.did().clone(), bob.did().clone(), TrustScore::unchecked(0.5)))
        .unwrap();
    multi
        .economic_mut()
        .add_edge(TrustEdge::new(
    ...
    multi
        .technical_mut()
        .add_edge(TrustEdge::new(alice.did().clone(), dave.did().clone(), TrustScore::unchecked(0.5)))
        .unwrap();

    // Bob also appears in economic
    multi
        .economic_mut()
        .add_edge(TrustEdge::new(alice.did().clone(), bob.did().clone(), TrustScore::unchecked(0.3)))
        .unwrap();
...
fn test_add_edge_validated_with_legacy_evidence() {
    ...
    let edge = TrustEdge::new(alice.did().clone(), bob.did().clone(), TrustScore::unchecked(0.7)).with_evidence(
...
fn test_add_edge_validated_empty_evidence() {
    ...
    let edge = TrustEdge::new(alice.did().clone(), bob.did().clone(), TrustScore::unchecked(0.5));

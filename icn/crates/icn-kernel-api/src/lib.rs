...
pub use proofs::{
    ...
    StateDigest, SyncDegradedStatus, SyncDegradedStatusError, TriggerSource,
    ...
    PEER_SYNC_REPORT_SCHEMA_VERSION, QUORUM_SYNC_CHECK_SCHEMA_VERSION, REPAIR_PLAN_SCHEMA_VERSION,
    REPAIR_RECEIPT_SCHEMA_VERSION, SYNC_DEGRADED_STATUS_SCHEMA_VERSION,
};
pub use receipts::{

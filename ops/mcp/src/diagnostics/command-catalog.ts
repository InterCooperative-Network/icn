  ...
  groups: [
    {
      ...
      commands: [
        ...
        {
          id: "mcp_export_contracts",
          purpose: "Regenerate committed agent MCP contract JSON from TypeScript source",
          command: "npm run export:contracts",
          working_directory: "ops/mcp",
          safety: "modifies_local",
          runtime: "quick",
          when_to_use: "After editing diagnostics/schema.ts or diagnostics/tool-schemas.ts.",
          caution: "Rewrites docs/guides/developer/agent-mcp-contracts.json; review diff before commit.",
        },
        {
          id: "mcp_contract_drift_test",
          purpose: "Run drift test only for agent-mcp-contracts.json",
          command: "npx vitest run src/tests/agent-mcp-contract-drift.test.ts",
          working_directory: "ops/mcp",
          safety: "read_only",
          runtime: "quick",
          when_to_use: "Quick check that committed contract matches generator.",
        },
      ],
    },
    {

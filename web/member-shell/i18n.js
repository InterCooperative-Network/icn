...
(function () {
  ...
  var MESSAGES = {
    en: {
      ...
      // Pending-publish review preview (#1726). Read-only rows proposed for
      // review before anything is recorded or published.
      "pendingPublish.heading": "Review preview",
      "pendingPublish.explain": "These are items proposed for review before anything is recorded or published. Each shows what it is, where it applies, its review status, and what evidence is expected later. Nothing here authorizes, publishes, or completes anything.",
      "pendingPublish.boundary": "Preview rows are evidence presented for review. They are not authorization, publication, custody writes, or completed actions.",
      ...
      // --- Pending-publish review preview (#1726) -----------------------
      "pp.origin.committedFixture": "Fictional rehearsal data (committed fixture)",
      "pp.origin.liveRuntime": "Live node data",
      "pp.origin.rehearsalRuntime": "Rehearsal node data (fictional)",
      "pp.empty.fixture": "No rehearsal rows in this fixture.",
      "pp.empty.live": "This node has no items awaiting review right now.",
      "pp.kind.actionItem": "Action item",
      "pp.kind.decision": "Decision",
      "pp.kind.attendance": "Attendance",
      "pp.kind.obligation": "Obligation",
      "pp.kind.allocation": "Allocation",
      "pp.kind.settlement": "Settlement",
      "pp.kind.evidenceNote": "Evidence note",
      "pp.kind.riskNote": "Risk note",
      "pp.status.pendingReview": "Awaiting review",
      "pp.status.approvedForPublish": "Approved to stage the next step",
      "pp.status.rejected": "Set aside — not recorded",
      "pp.status.needsEdit": "Needs an edit before review",
      "pp.status.needsMoreInfo": "Needs more information",
      "pp.beforeYouRead": "Before you read this: {hint}",
      "pp.kv.whereApplies": "Where this applies",
      "pp.kv.governingBody": "Governing body",
      "pp.kv.assignee": "Suggested assignee",
      "pp.assignee.whatIsThis": "What is this?",
      "pp.assignee.note": "This is an organizer-readable label, not a DID. Identity binding is a separate private step.",
      "pp.kv.whyProposed": "Why it is proposed here",
      "pp.noAuthorityBasis": "(no basis given)",
      "pp.kv.careLevel": "Care level",
      "pp.kv.expectedEvidence": "Expected evidence",
      "pp.receipt.expected": "A {category} is expected later. It has not been issued; this row does not create it.",
      "pp.receipt.notExpected": "No receipt is expected for this row.",
      "pp.receipt.governance": "governance receipt",
      "pp.receipt.attendance": "attendance receipt",
      "pp.receipt.actionItemCompletion": "action-item completion receipt",
      "pp.receipt.settlement": "settlement receipt",
      "pp.receipt.none": "none",
      "pp.showTechnical": "Show technical detail",
      "pp.kv.rowId": "Row id",
      "pp.kv.provenance": "Where this came from",
      "pp.prov.committedFixture": "Committed fixture (fictional)",
      "pp.prov.meetingRecord": "Meeting record",
      "pp.prov.governanceRecord": "Governance record",
      "pp.prov.exampleSnippet": "Example snippet",
      "pp.prov.repoSafePaste": "Repo-safe paste",
      "pp.prov.priorEvidencePacket": "Prior evidence packet",
      "pp.kv.rawKind": "Raw kind / status / risk",
      ...
      // --- Organizer rehearsal review→confirm surface (#2386, ?surface=organizer,
      // live-only). Drives the Rehearsal-mode runtime routes. Every string here is
      // organizer-facing; the raw enum value never appears in copy. -----------
      "banner.organizer": "Rehearsal mode — fictional data on an isolated node. Not a pilot, not live federation. Confirming creates real records on this node.",
      "organizer.connect.heading": "Connect to a local Rehearsal-mode node",
      ...
      "organizer.domain.legend": "Domain",
      "organizer.domain.member": "member",
      "organizer.domain.open": "Open workspace",
      "organizer.domain.chooseFirst": "Choose a domain to open its workspace.",
      "organizer.domain.none": "You are not a member of a domain with a rehearsal workspace. Ask a steward to set one up.",

      "organizer.workspace.heading": "Proposed work",
      "organizer.workspace.context": "Rehearsal workspace for {domain} — generation {generation}. Fictional data; confirming creates real records on this isolated node.",
      "organizer.workspace.loading": "Loading the rehearsal workspace…",
      "organizer.workspace.uninitialized": "This domain's rehearsal workspace has not been set up yet. A steward initializes the fictional workspace using an internal setup credential; this organizer view cannot create it.",
      "organizer.workspace.checkAgain": "Check again",
      "organizer.workspace.empty": "This rehearsal workspace has no proposed work right now.",
      "organizer.workspace.selectRow": "Select an item to review it.",

      "organizer.row.reviewButton": "Review this item",
      "organizer.row.selected": "Selected",

      "organizer.detail.heading": "Review: {kind}",
      "organizer.detail.version": "Version {version}",
      "organizer.detail.executed": "This item was already confirmed and created on the node. It cannot be changed.",
      "organizer.detail.backToList": "Back to the list",

      "organizer.review.heading": "Your review",
      "organizer.review.approve": "Approve for the next step",
      "organizer.review.reject": "Reject",
      "organizer.review.needsEdit": "Request an edit",
      "organizer.review.needsMoreInfo": "Ask for more information",
      "organizer.review.noteLabel": "Note (optional)",
      "organizer.review.notePlaceholder": "Add a short note for the record",
      "organizer.review.approveNote": "Approving does not by itself publish or create anything.",
      "organizer.review.submitting": "Recording your review…",
      "organizer.review.recorded": "Review recorded: {status}.",

      "organizer.edit.heading": "Edit the summary",
      "organizer.edit.label": "Summary (the only field you can change, up to 256 characters)",
      "organizer.edit.save": "Save summary",
      "organizer.edit.note": "Editing returns this item to “awaiting review” and clears any prior approval and preview.",
      ...
      "organizer.assign.none": "— unassigned —",
      "organizer.assign.bound": "bound",
      "organizer.assign.unbound": "needs steward setup",
      "organizer.assign.save": "Update assignment",
      "organizer.assign.clear": "Clear assignment",
      "organizer.assign.note": "Labels are registered by a steward. You can select or clear a label; you never create one or see a DID. An unbound label needs steward setup before you can confirm.",
      "organizer.assign.saving": "Updating the assignment…",
      "organizer.assign.saved": "Assignment updated.",
      "organizer.assign.noLabels": "No labels are registered in this workspace yet. A steward registers them.",

      "organizer.preview.button": "Preview what confirming will create",
      "organizer.preview.notExecutable": "This kind of proposed work can be reviewed but is not something this rehearsal slice can create.",
      "organizer.preview.needsApproval": "Approve this item on its current version before previewing.",
      "organizer.preview.loading": "Building the preview…",
      "organizer.preview.heading": "Preview: what confirming will create",
      "organizer.preview.action": "Create one action item on this Rehearsal Node",
      "organizer.preview.privacy": "Privacy: value-withheld — identities appear only as labels.",
      "organizer.preview.kv.action": "Action",
      "organizer.preview.kv.title": "Title",
      "organizer.preview.kv.description": "Description",
      "organizer.preview.kv.domain": "Domain",
      "organizer.preview.kv.assignee": "Assignee",
      "organizer.preview.kv.authority": "Authority basis",
      "organizer.preview.kv.risk": "Care level",
      "organizer.preview.kv.receipts": "Expected receipts",
      "organizer.preview.kv.reversible": "Reversible",
      "organizer.preview.kv.createsItem": "Creates a real action item",
      "organizer.preview.reversibleNo": "No — it creates a real item and permanent receipts",
      "organizer.preview.createsYes": "Yes",
      "organizer.preview.assigneeBound": "{label} (label, bound)",
      "organizer.preview.assigneeUnbound": "{label} (label, needs steward setup)",
      "organizer.preview.assigneeNone": "Unassigned",
      "organizer.preview.notConfirmable": "This preview cannot be confirmed yet: its assignee label needs steward setup.",
      "organizer.preview.continue": "Continue to confirm",
      "organizer.preview.cancel": "Cancel preview",
      "organizer.preview.showTechnical": "Show technical details (digest, ids)",
      "organizer.preview.kv.digest": "Preview digest (computed by the node)",
      "organizer.preview.kv.planId": "Plan id",

      "organizer.confirm.heading": "Confirm this rehearsal mutation",
      "organizer.confirm.warning": "You are about to create one real action item and permanent process receipts on this isolated Rehearsal Node. Fictional data; not a pilot; receipts record process facts and grant no authority.",
      "organizer.confirm.button": "Confirm and create the action item",
      "organizer.confirm.back": "Go back",
      "organizer.confirm.submitting": "Confirming…",
      "organizer.confirm.stale": "The proposed work changed since this preview was made. Review the current version and preview again.",

      "organizer.result.heading": "Created one action item on this Rehearsal Node",
      "organizer.result.body": "It is now assigned to “{label}” and appears as an action card. The receipts below record what happened; they grant no authority.",
      "organizer.result.bodyUnassigned": "It was created unassigned and appears as an action card. The receipts below record what happened; they grant no authority.",
      "organizer.result.idempotent": "This preview was already confirmed; nothing new was created.",
      "organizer.result.showTechnical": "Show technical details (ids and hashes)",
      "organizer.result.kv.actionItemId": "Action item id",
      "organizer.result.kv.sessionId": "Process session id",
      "organizer.result.kv.decisionId": "Decision id",
      "organizer.result.kv.activationId": "Activation id",
      "organizer.result.kv.planId": "Plan id",
      "organizer.result.kv.applicationId": "Application id",
      "organizer.result.kv.resultHash": "Result hash",
      "organizer.result.viewReceipts": "View process receipts",
      "organizer.result.viewEvidence": "View evidence summary",

      "organizer.receipts.heading": "Process receipts",
      "organizer.receipts.explain": "These record what happened on the node — ids and hashes only, no identities. They record process facts and grant no authority.",
      "organizer.receipts.none": "No process receipts yet.",
      "organizer.receipts.class.processSessionOpened": "Process session opened",
      "organizer.receipts.class.decisionRecorded": "Decision recorded",
      "organizer.receipts.class.processGateResult": "Gate result",
      "organizer.receipts.class.activationCrossed": "Activation crossed",
      "organizer.receipts.class.mutationPlanRecorded": "Mutation plan recorded",
      "organizer.receipts.class.mutationApplied": "Mutation applied",
      "organizer.receipts.kv.id": "Record id",
      "organizer.receipts.kv.recordHash": "Record hash",
      "organizer.receipts.kv.rowId": "Item id",
      "organizer.receipts.kv.decision": "Decision",
      "organizer.receipts.kv.bodyHash": "Body hash",
      "organizer.receipts.kv.actionItemId": "Action item id",
      "organizer.receipts.kv.references": "References",

      "organizer.evidence.heading": "Evidence summary",
      "organizer.evidence.explain": "A value-withheld summary of this rehearsal — outcomes, decisions, and receipt hashes, no identities. Both packet hashes are computed by the node and can be independently verified by a steward; this page does not claim to have verified them.",
      "organizer.evidence.none": "No evidence to summarize yet.",
      "organizer.evidence.kv.contract": "Contract",
      "organizer.evidence.kv.domain": "Domain",
      "organizer.evidence.kv.generation": "Generation",
      "organizer.evidence.kv.run": "Run id",
      "organizer.evidence.outcomesHeading": "What the rehearsal recorded",
      "organizer.evidence.rowLine": "{kind}: {outcome}",
      "organizer.evidence.privacyReview": "Privacy review: {result}",
      "organizer.evidence.showTechnical": "Show packet hashes",
      "organizer.evidence.kv.packetHash": "Packet hash (BLAKE3, node-computed)",
      "organizer.evidence.kv.packetHashSha256": "Packet hash (SHA-256 mirror, node-computed)",
      "organizer.evidence.nonClaimsHeading": "What this is not",
      "organizer.outcome.executed": "Confirmed and created",
      "organizer.outcome.interruptedExecution": "Interrupted — retry to resume",
      "organizer.outcome.rejected": "Rejected",
      "organizer.outcome.editAndResubmit": "Edited — awaiting review",
      "organizer.outcome.approvedNotExecuted": "Approved, not yet created",
      "organizer.outcome.deferred": "Deferred",

      "organizer.member.heading": "Continue as the assigned member",
      "organizer.member.explain": "To complete the action card, open the member surface and connect with a member credential (governance:read and governance:action-item:complete). This organizer credential cannot complete items.",
      "organizer.member.link": "Open the member surface",

      "organizer.error.401": "Your session is unavailable or expired. Connect again.",
      "organizer.error.403": "This credential lacks the authority for that step.",
      "organizer.error.404": "That item or workspace is no longer available.",
      "organizer.error.409": "The item changed — review the refreshed state and try again.",
      "organizer.error.422": "That label is not bound, or this item cannot be confirmed here.",
      "organizer.error.500": "The node could not complete the request. Nothing was assumed done.",
      "organizer.error.generic": "The request did not complete."
    }

...
pub use federation::{
    FederationRuntime, FederationError, MonitoringStatus, MonitoringResult, MonitoringOptions, 
    DagStatus, ProposalAudit, FinalizationReceipt, FederationManifest, IFederationSync, MockFederationSync
};
...
pub use services::{
    FederationSyncService, FederationSyncConfig, FederationSyncError,
    CredentialSyncData, CredentialStatus, CredentialTrustScore
}; 
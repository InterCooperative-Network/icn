...
/// Configuration for quorum decisions
...
pub mod initialization {
    use super::*;
    use icn_identity::generate_did_key;
...
/// Functions for quorum decisions
pub mod decisions {
    use super::*;
    use icn_identity::{IdentityId, Signature, QuorumProof};
    ...
    pub async fn create_quorum_proof(
        ...
        // Convert quorum config to identity crate's QuorumConfig

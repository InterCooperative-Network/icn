...
On the dev host, agent sessions follow the `~/icn-dev` bare-store/worktree operating model — see `docs/dev/AGENT_WORKTREE_POLICY.md` for worktree allocation, file locks, and the merge queue.

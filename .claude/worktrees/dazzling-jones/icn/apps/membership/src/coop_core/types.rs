...
impl From<MemberStatus> for crate::entity_core::membership::UnifiedMembershipStatus {
...
mod tests {
    ...
    fn test_member_status_to_unified_pending() {
        let unified: crate::entity_core::membership::UnifiedMembershipStatus =
            MemberStatus::Pending.into();
        assert_eq!(
            unified,
            crate::entity_core::membership::UnifiedMembershipStatus::Pending
        );
    }
    ...
    fn test_member_status_to_unified_active() {
        let unified: crate::entity_core::membership::UnifiedMembershipStatus =
            MemberStatus::Active.into();
        assert_eq!(
            unified,
            crate::entity_core::membership::UnifiedMembershipStatus::Active
        );
    }
    ...
    fn test_member_status_to_unified_suspended() {
        let unified: crate::entity_core::membership::UnifiedMembershipStatus =
            MemberStatus::Suspended.into();
        assert_eq!(
            unified,
            crate::entity_core::membership::UnifiedMembershipStatus::Suspended
        );
    }
    ...
    fn test_member_status_to_unified_removed() {
        let unified: crate::entity_core::membership::UnifiedMembershipStatus =
            MemberStatus::Removed.into();
        assert_eq!(
            unified,
            crate::entity_core::membership::UnifiedMembershipStatus::Terminated
        );
    }
    ...
    fn test_member_status_reference_conversion() {
        ...
        let unified: crate::entity_core::membership::UnifiedMembershipStatus = (&status).into();
        assert_eq!(
            unified,
            crate::entity_core::membership::UnifiedMembershipStatus::Active
        );

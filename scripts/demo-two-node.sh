...
if [ ! -f /tmp/icn-alpha/identity.age ]; then
    ICN_PASSPHRASE="testpass123" ./target/release/icnctl --data-dir /tmp/icn-alpha id init || {
...
if [ ! -f /tmp/icn-beta/identity.age ]; then
    ICN_PASSPHRASE="testpass123" ./target/release/icnctl --data-dir /tmp/icn-beta id init || {

...
- **Join community coordination**: read the public [Community](https://intercooperative.network/community) page. Existing invitees use [ICN Matrix chat](https://chat.icn.zone); durable decisions and work remain in issues, discussions, pull requests, ADRs, RFCs, and project documents.

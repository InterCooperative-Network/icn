...
echo ""
echo " What is now live (PR #1327 ExecutionReceiptGate, merged 2026-03-07):"
echo "   ✓ Machine-verifiable binding: execution gate enforced at proposal close"
echo "     (no ProposalAccepted fires without passing check_execution_gate)"
echo "   ✓ Kernel enforcement: unauthorized allocation blocked, not just recorded"
echo "   ✓ Signed GovernanceReceipt: proof endpoint returns Ed25519-signed receipt"
echo "     (requires signing key configured in pod — see Flow 4 Step 11)"
echo ""
echo " What remains:"
echo "   · Defense-in-depth at ledger write-path (optional future hardening)"
echo "   · Pod signing key must be configured for /proof endpoint to return attestation"
echo "================================================================"
